...
| R22 | **Posisi ban berbeda per tipe truk** (jumlah/axle beda) | M | Sedang | 🟠 | Master `wks_mst_axle_positions` per `axle_config`; posisi instalasi divalidasi + diagram layout | Termitigasi |
